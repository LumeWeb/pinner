...
// (mcpplane/transfer's core executor contract, transfer.UploadHandler). It
// buffers the stream to a temp file, applies the wrap/archive rules, and
// proxies into the uploads.Service. It is IPFS-only — no vault — and never
// formats output; callers own tool descriptors and presentation.
//
// Behavior:
//
