...
// Characterization tests for the Pinner prompts, pinned against
// pinner-cli internal/mcp/prompts_test.go: prompt-set gating per surface and
// deterministic template rendering with embedded resource references.

func TestPromptNamesFullSurface(t *testing.T) {
	prompts := PromptDescriptorsForSurface(pinnerops.FullSurface)
...
func TestWebsiteOnboardingValidation(t *testing.T) {
	p := promptByName(t, PromptDescriptorsForSurface(pinnerops.FullSurface), PromptWebsiteOnboarding)
...
func TestWebsiteUpdatePrompt(t *testing.T) {
	p := promptByName(t, PromptDescriptorsForSurface(pinnerops.FullSurface), PromptWebsiteUpdate)
...
func TestENSPublishPrompt(t *testing.T) {
	p := promptByName(t, PromptDescriptorsForSurface(pinnerops.FullSurface), PromptENSPublish)
...
func TestSetupPrompt(t *testing.T) {
	p := promptByName(t, PromptDescriptorsForSurface(pinnerops.FullSurface), PromptSetup)
