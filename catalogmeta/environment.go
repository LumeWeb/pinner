...
// belongs instead of frontends hard-coding name skip-lists. This is the
// former pinner.Environment vocabulary, relocated to the frontend-metadata
// boundary: the core opmesh model deliberately has no Environment field, and
// the assembly layer (pinnerops) gates registration on it.
