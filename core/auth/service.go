// Package auth provides the authentication domain for the pinner service.
//
// AuthService returns typed results and logs debug information through an
// injected *zap.Logger rather than presenting anything itself. Callers
// depend on the AuthService interface and are responsible for rendering the
// returned results.
package auth
...
// successful authentication. It carries the data a caller needs to render a
...
// It separates presentation concerns from authentication operations.
