...
// content from the Pinner content-network. It carries the service interface,
// result models, and dependency-injection options; concrete implementations
...
// the Pinner service. Implementations supply the concrete SDK wiring;
