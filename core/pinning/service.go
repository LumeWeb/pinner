// Package pinning provides the pinning domain for the pinner service.
//
// The PinningService and StatusService interfaces and their data models live
// here; the PinningServiceFactory constructor takes no presentation-layer
// dependencies. Callers depend on the interfaces and are responsible for
// rendering the returned results.
package pinning
...
// It is free of presentation-layer coupling.
