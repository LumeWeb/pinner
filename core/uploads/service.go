...
// the IPFS network via the Pinner service. It carries the service interface
// and result model; concrete implementations and their IO-level configuration
// options are supplied by the consumer.
package uploads
