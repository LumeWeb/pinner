...
func TestQuotaAdminService_Unauthenticated(t *testing.T) {
	...
	require.Error(t, err)
	_, _, err = svc.ListAllowances(ctx, nil)
	require.Error(t, err)
	...
	require.Error(t, err)
	_, _, err = svc.ListUserConfigs(ctx, nil)
	require.Error(t, err)
...
func TestBillingAdminService_Unauthenticated(t *testing.T) {
	...
	require.Error(t, err)
	_, _, err = svc.ListPriceLines(ctx, nil)
	require.Error(t, err)
	...
	require.Error(t, err)
	_, _, err = svc.ListPricingPlans(ctx, nil)
	require.Error(t, err)
	...
	require.Error(t, err)
	_, _, err = svc.ListPricingPlanPeriods(ctx, nil)
	require.Error(t, err)
	...
	require.Error(t, err)
	_, _, err = svc.ListSubscribers(ctx, nil)
	require.Error(t, err)
