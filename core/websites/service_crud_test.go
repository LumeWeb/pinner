...
// is pinned. This is what keeps a long-lived service live-reload aware: a
...
// into a long-lived service via SetAuthToken (as the config subscription
// does on live-reload) hot-updates the retained *ipfs.Client rather
