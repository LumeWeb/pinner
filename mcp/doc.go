...
// operation set: the Pinner prompts, resources, curated tool names,
...
// everything catalogmcp excludes: prompts, resources, curated names,
...
//
// No package globals: every piece of instance state — the surface, the
