...
// interface so the composition root can satisfy it from whatever website
// service it already owns: an implementation exposing these five reads
// satisfies the interface without adaptation.
