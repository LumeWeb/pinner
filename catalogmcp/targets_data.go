...
// opTargets maps an operation ID to the MCP per-profile targets that were
// declared inline on the operation during the pre-migration pinner model.
...
// FallbackFunc. The data was extracted verbatim from the catalogops
// definitions during the opmesh migration.
